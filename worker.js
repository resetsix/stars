...
async function handleRequest(request) {
  const response = await fetch('https://gcore.jsdelivr.net/gh/resetsix/starts/data.json');   //这里的xxx修改为自己仓库的json raw文件
...
function generateHTML(data) {
  ...
  return `
    ...
    <head>
      ...
      <title>Resetsix's GitHub Stars 导航</title>
    ...
    <body class="bg-gray-100">
      <div class="sticky-header flex justify-between items-center px-4 py-2 bg-white shadow-md">
        <h1 class="text-2xl font-bold">
          <a href="https://resetsix.cn/" class="hidden md:block">Resetsix's GitHub Stars 导航</a>
        </h1>
      ...
      <div class="text-center py-4">
        Copyright © 2024 <a href="https://resetsix.cn/" class="text-blue-500 hover:underline">Resetsix's</a> . All Rights Reserved.
      </div>
